...
client.on('guildMemberAdd', member => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField(':loudspeaker: | New phoenix has come' , `Hey, ${member}`)
        .addField(':		id: | user :', "**[" + `${member.id}` + "]**" )
                .addField('➡| Member NO',`${member.guild.memberCount}`)
    ...
    client.on('guildMemberRemove', member => {
        ...
        .setTitle(`Phoenix has left The nest :( :raised_hand::skin-tone-1: :pensive:`)
        .setDescription(`Try come back :raised_hand::skin-tone-1: :pensive: `)
        .addField(':bust_in_silhouette:   Remained',`**[ ${member.guild.memberCount} ]**`,true)
        .setColor('RED')
        .setFooter(`====Thanks for having us====`, ' https://cdn.discordapp.com/attachments/397818254439219217/399292026782351381/shy.png')
...
client.on('ready', () => {
   client.user.setGame(" ⚡ ThundeЯ🔥 Phoeni✘⚡ ");
}); 
...
client.on("message", message => {
 ...
 client.on('guildMemberAdd', member => {
  ...
  if (!channel) return;
  channel.send(`***Welcome to Thunder Phoenix Check #rules & #roles Please***, ${member}`);
...
if (message.content === '^^support') {
      message.author.send(' |https://discord.gg/mZszR3D| لـ أي استفسار').catch(e => console.log(e.stack));
...
client.login('NDkwNjYwMzUwNjk0MzkxODM5.Dn8i1A.4qwkq0gqV6ZeutUsbWcfIKiC8_U');
